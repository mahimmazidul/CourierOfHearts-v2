...
export const ALL_FLOWERS = [
  ...
  { id: 'ivory-rose', name: 'Ivory Rose', Component: RoseFlower, defaultColor: '#d8cfbf' },
  { id: 'moon-lily', name: 'Moon Lily', Component: LilyFlower, defaultColor: '#dcd6ca' },
  { id: 'white-blossom', name: 'White Blossom', Component: CherryBlossomFlower, defaultColor: '#e8e1d4' },
  { id: 'pearl-daisy', name: 'Pearl Daisy', Component: DaisyFlower, defaultColor: '#ddd6c8' },
  { id: 'snow-tulip', name: 'Snow Tulip', Component: TulipFlower, defaultColor: '#e2dbcf' },
] as const;
